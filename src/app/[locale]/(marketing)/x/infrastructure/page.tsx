    ...
    <div style={{ backgroundColor: "#0D0D0D", minHeight: "100vh" }}>
      ...
      <section className="relative pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" style={{
          background: "radial-gradient(ellipse 70% 60% at 15% 50%, rgba(59,130,246,0.06) 0%, transparent 65%)",
        }} />
        ...
        <div className="max-w-screen-xl mx-auto px-8 md:px-16 lg:px-24 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                <Server size={30} style={{ color: "#3B82F6" }} strokeWidth={1.3} />
              </motion.div>
            ...
            {USECASES.map((u, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                ...
                <span className="inline-block px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider rounded-md mb-5"
                  style={{ backgroundColor: "rgba(59,130,246,0.1)", color: "#60A5FA", fontFamily: "var(--font-inter)" }}>{u.tag}</span>
